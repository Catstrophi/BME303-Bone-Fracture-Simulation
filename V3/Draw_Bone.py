...
def draw_bone(window, grid_size, cell_size, fracture_gap, random_index):
    ...
    def create_fracture(gap):
        ...
        for y in range(46, 54):
            left_edges[y] = center_x - (gap // 2) + random_index.randint(-3, 3)
            right_edges[y] = center_x + (gap // 2) + random_index.randint(-3, 3)
